...
var question_list = {
	...
	redirectUrl : function(newparam) {
		var pageSwitch = $("#page-switch-hidden").val();
		if(pageSwitch=="questionTest_list"){
            var paramurl = newparam.searchParam;
            paramurl = paramurl + "-" + newparam.page;
            paramurl = paramurl + ".html";

            document.location.href = document.getElementsByTagName('base')[0].href
                + util.getCurrentRole() + '/question/questionTest-list/filter-' + paramurl;
