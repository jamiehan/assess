...
//	request.setAttribute("leftMenuId",list[3]);
	...
	CmsExpert expert = (CmsExpert)request.getAttribute("cmsExpert");
%>
	...
	<div class="row">
		...
		<div class="col-xs-10" id="right-content">
			<div class="page-header">
				<h1><i class="fa fa-bar-chart-o"></i> 修改专家库 </h1>
			</div>
			...
			<div class="form-line add-update-examname  page-content">
				<span class="form-label"><span class="warning-label">*</span>专家库名称：</span>
				<input id="title2" type="text" class="df-input-narrow">
...
<script type="text/javascript">
	...
	var id = <%= expert.getId()  %>
	var title = "<%= expert.getTitle() %>";
	var content = "<%= expert.getContent() %>";
	...
	$("#submit").click(function(){
		...
		if(!catId){
			...
			var jsonObj = {"catId":catId,"title": title,"content":content};
			$.ajax({
				cache: true,
				type: "POST",
				url: "<%=request.getContextPath()%>/admin/expert/cmsExpert_update_up/" + id ,
