		...
		<div class="row">
			...
			<div class="col-xs-10" id="right-content">
				<div class="page-header">
					<h1><i class="fa fa-bar-chart-o"></i>分类管理</h1>
				</div>
				<div class="page-content">
					<div id="dep-list">
						...
						<table class="table-striped table">
							...
							<tbody>
							<c:forEach items="${cmsCatList1 }" var="items">
									...
									<td>
										<c:choose>
											<c:when test="${items.creator == sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}">
												<a class="change-property btn-sm btn-info" href="<%=basePath%>admin/rules/cat_update/${items.id}"><i class="ace-icon fa fa-pencil bigger-120" id="${items.id}"></i></a>
												<a class="delete-cat-btn btn-sm btn-danger" id="${items.id}"><i class="ace-icon fa fa-trash-o bigger-120"></i></a>
				...
				<div class="page-content">
					<div id="dep-list2">
						<div class="table-controller">
							<div class="btn-group table-controller-item" style="float:left">
								<i class="fa fa-plus-square"></i>
								<a href="<%=basePath%>/admin/exoert/expert_cat_add">添加专家库分类</a>
						...
						<table class="table-striped table">
							...
							<tbody>
							<c:forEach items="${cmsCatList2 }" var="items">
								<tr><td style="display:none;">
									<input type="checkbox" value="${items.id }">
								</td>
									<td>${items.id}</td>
        ...
        $(".delete-cat-btn").click(function(){
            ...
            if(confirm("确定要删除吗？删除后无法恢复")){
                jQuery.ajax({
                    ...
                    type : "GET",
                    url : '/admin/cms/delete-cat/' + cat_id,
