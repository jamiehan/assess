	...
	<div class="row">
		...
		<div class="col-xs-10" id="right-content">
			<div class="page-header">
				<h1><i class="fa fa-bar-chart-o"></i> 添加专家库分类 </h1>
			</div>
		...
		<!-- Slider (Flex Slider) -->
			<div class="form-line add-update-examname page-content" >
				...
				<input id="cat_name" type="text" class="df-input-narrow">
				<span class="form-message"></span>
				<input id="btn-cat-save" value="添加" type="submit" class="df-submit btn btn-info">
			</div>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	$("#btn-cat-save").click(function(){
		...
		if(!name){
            ...
            alert(name);
			var jsonObj = {"catName": name, "type":"2"};
			$.ajax({
				cache: true,
				type: "POST",
				url: "<%=request.getContextPath()%>/admin/cms/cms_cat_add_in",
