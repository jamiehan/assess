				...
				<div class="row">
					<div class="col-xs-2" id="left-menu">
						<ul class="nav default-sidenav">
							...
							<li>
								<a href="<%=list[1]%>/exam/exam-add" title="发布考试"><i class="fa fa-plus-square-o">&nbsp;</i><span class="left-menu-item-name"> 发布考试</span></a>
							</li>
							<li>
								<a href="<%=list[1]%>/exam/model-test-add" title="发布模拟考试"><i class="fa fa-flag">&nbsp;</i><span class="left-menu-item-name"> 发布模拟考试</span></a>
							</li>
						</ul>
					</div>
   							...
   							<div class="bs-example bs-example-bg-classes" data-example-id="contextual-backgrounds-helpers">
							    <p class="bg-success">
							    	<i class="ace-icon fa fa-check green"></i>
							   		...
							   		欢迎使用育涵科技后台管理系统，您可以在此页面快速查看您系统的状态。
							    </p>
