	...
	<div class="row">
		...
		<div class="col-xs-10" id="right-content">
			<div class="page-header">
				<h1><i class="fa fa-bar-chart-o"></i> 修改资料 </h1>
			</div>
			...
			<div class="container" style="min-height:500px;">
				...
				<script id="txt" name="txt" type="text/plain" style="width:680px;"></script><script type="text/javascript">
...
<script type="text/javascript">
	...
	var id = <%= rules.getId()  %>
	var title = "<%= rules.getTitle() %>";
	var content = "<%= rules.getContent() %>";
	...
	$("#submit").click(function(){
		...
		if(!catId){
			...
			$.ajax({
				cache: true,
				type: "POST",
				url: "<%=request.getContextPath()%>/admin/rules/cmsRules_update_up/" + id ,
