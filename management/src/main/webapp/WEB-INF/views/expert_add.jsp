...
<div class="container" style="min-height:500px;">
	...
	<div class="col-xs-2" id="left-menu">
		...
		<div class="col-xs-10" id="right-content">
			<div class="page-header">
				<h1><i class="fa fa-bar-chart-o"></i> 添加专家库 </h1>
			</div>

            <%--<div class="form-line add-update-examname page-content" >--%>
            <div class="form-line page-content">
                <span class="form-label"><span class="warning-label">*</span>专家库类型：</span>
                <%--<select id="cat_id">--%>
	...
	<div class="container" style="min-height:500px;">
		<script id="txt" title="txt" label="txt" name="txt" type="text/plain" style="width:680px;"></script>
	...
	$("#submit").click(function(){
		...
		if(!name){
			...
			$.ajax({
				cache: true,
				type: "POST",
				url: "<%=request.getContextPath()%>/admin/cms/cmsExpert_add_in",
