						...
						<div class="page-content">
							...
							<div id="exampaper-list">
								<div class="table-search table-controller-item"	style="float: left; margin-top:10px;">
									...
									<div class="btn-group table-controller-item" style="float: left">
										<button class="btn btn-default btn-sm" id="export-scores-btn">
											<i class="fa fa-random"></i> 导出成绩
										</button>
									</div>
								</div>
			...
			$(function(){
				...
				$("#export-scores-btn").click(function(){
					...
					$.ajax({
						...
						type : "GET",
						url : util.getCurrentRole() + "/exam/export-"+examId,
