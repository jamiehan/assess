...
public class UserAction {
	...
	@RequestMapping(value = "/secure/user-import", method = RequestMethod.POST)
	public @ResponseBody Message userImport(@RequestBody User user) {
		Message message = new Message();
...
////			filePath,flieList // question
			userService.userImport(user, userInfo.getUsername());
