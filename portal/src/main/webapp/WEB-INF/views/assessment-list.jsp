			...
			<div class="container">
				<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
					<ul class="nav navbar-nav">
						...
						<%--</li>--%>
						<li>
							<a href="rules-list"><i class="fa fa-file-text-o"></i>规章制度</a>
						</li>
						<li>
							<a href="expert-list"><i class="fa fa-cloud"></i>专家题库</a>
						</li>
						<li class="active">
							<a href="assessment-list"><i class="fa fa-trophy"></i>考核评价记录</a>
						</li>
						<li>
			...
			<div class="container" style="margin-top: 40px;">
				<div class="row">
						<div class="col-xs-12">
							...
							<h3 class="title"><i class="fa fa-book"></i>考核评价记录</h3>
